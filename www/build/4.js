...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_friend__ = __webpack_require__(794);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__qr_scan_qr_scan_module__ = __webpack_require__(740);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_friend_add_friend_module__ = __webpack_require__(746);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__friend_list__ = __webpack_require__(166);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FriendListPageModule = /** @class */ (function () {
    ...
    FriendListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_5__friend_list__["a" /* FriendListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_5__friend_list__["a" /* FriendListPage */]),
...
var AddFriendPage = /** @class */ (function () {
    ...
    AddFriendPage.prototype.pushFriendRequest = function (fId) {
        return __awaiter(this, void 0, void 0, function () {
            var fRef_1, uRef_1, err, err, isBlocked, ref, is, err, fReq, fReqGet, fReqList, msg, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        fRef_1 = __WEBPACK_IMPORTED_MODULE_2_firebase__["firestore"]().collection('Users').doc(fId);
                        uRef_1 = __WEBPACK_IMPORTED_MODULE_2_firebase__["firestore"]().collection('Users').doc(this.user.uid);
                        ...
                        if (this.user.friendList.length > 0 && undefined != this.user.friendList.find(function (ele) { return ele.isEqual(fRef_1); })) {
                            err = this.toastCtrl.create({
                        ...
                        isBlocked = false;
                        return [4 /*yield*/, fRef_1.get()];
                    case 1:
                        ref = _a.sent();
                        return [4 /*yield*/, ref.data().blockedUsers.find(function (bu) { return bu.isEqual(uRef_1); })];
                    case 2:
                        is = _a.sent();
                        if (undefined != is) {
                            err = this.toastCtrl.create({
                    ...
                    case 3:
                        fReqGet = _a.sent();
                        is = fReqGet.data().friendRequest.find(function (fr) { return fr.from.isEqual(uRef_1); });
                        if (undefined == is) {
