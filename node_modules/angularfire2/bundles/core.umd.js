...
}(this, (function (exports,_angular_core,_angular_common,rxjs,rxjs_operators,firebase_app) { 'use strict';
...
function _firebaseAppFactory(options, nameOrConfig) {
    ...
    var existingApp = firebase_app.apps.filter(function (app) { return app && app.name === config.name; })[0];
    return (existingApp || firebase_app.initializeApp(options, config));
}
